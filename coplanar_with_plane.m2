...
-- q in E, r in E, l in {lines contained in H_0} = P^2
-- l = {x = l1y + l2z + l3w = 0}
R = QQ[q0,q1,q2,q3,r0,r1,r2,r3,l1,l2,l3,Degrees=>{4:{1,0,0,0},4:{0,1,0,0},3:{0,0,1,0},4:{0,0,0,1}}]
...
N = matrix{  {2*q0+2*q1+3*q2+4*q3, 2*q0+2*q1, 3*q0+2*q2, 4*q0-2*q3},
