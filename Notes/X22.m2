...
I1 := ideal(q0^2 - q0*q1 + q1^2 + q2^2 - q3^2, 
    3*q0^2 - 10*q0*q1 - 5*q0*q3 + 4*q1^2 + q2^2 + 6*q1*q3 + 2*q3^2)
I2 := ideal(r0^2 - r0*r1 + r1^2 + r2^2 - r3^2,
    3*r0^2 - 10*r0*r1 - 5*r0*r3 + 4*r1^2 + r2^2 + 6*r1*r3 + 2*r3^2)
...
-- forget about last column: D_1*M_1-D_2*M_2+D_3*M_3-D_4*M_4=0,
-- so D_1*M_1-D_2*M_2 represents the plane containing these lines
...
-- map P^3xP^3->(P^3)* is [R0:R1:R2:R3], then composition with (P^3)*->P^2
-- is [R1:R2:R3] <-> {x=R1y+R2z+R3w=0}
